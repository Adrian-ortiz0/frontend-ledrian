...
<div className="min-h-screen flex items-center justify-center relative overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-black via-gray-900 to-black bg-[length:200%_200%] animate-gradientMove"></div>
    ...
    <div className="backdrop-blur-lg bg-white/10 p-8 rounded-2xl shadow-lg max-w-sm w-full text-white relative z-10">
        ...
        <form className="flex flex-col space-y-4">
            ...
            <button className="bg-white/30 hover:bg-white/40 transition p-2 rounded-lg font-semibold" onClick={() => navigate("../home")}>Login</button>
        </form>
